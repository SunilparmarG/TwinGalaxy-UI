              ...
              <Col xl={10}>
                <div className='d-flex secondTopbar flex-wrap w-100 align-items-center flex-wrap flex-md-nopwrap justify-content-start position-relative pe-4'>
                  <div className='d-flex align-items-center mb-3 mb-xl-0 flex-1'>
                    ...
                    <Badges className="badges ms-4 border" iconSrc={Verified} badgeText="Verified" />
                  ...
                  <div className="text-start mb-3 mb-xl-0 flex-1">  
                    <Button variant='borderWhite' text='Customize' iconSrc={Customize} />   
                  </div>
                </div>
              </Col>
              <Col xl={2} className="d-flex justify-content-start justify-content-xl-end align-items-center">
